...
extracted_data=load_pdf("D:\ITSOLERA\AI healthcare\DoctorChatbot-backend\DATA")
...
pc = Pinecone() #setting up the env
...
qa = RetrievalQA.from_chain_type(
    llm=chat_model(temperature=0.8),      #randomness
    chain_type="stuff",
    retriever=docsearch.as_retriever(search_kwargs={"k": 1}), #retriever will return top results from doc
